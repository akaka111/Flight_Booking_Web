...
<div class="sidebar">
    ...
    <ul>
        ...
        <li>
            <a href="#" onclick="loadPage('${pageContext.request.contextPath}/ticketPrice'); return false;">
                <i class="fa-solid fa-ticket"></i> Quản Lý Giá Vé
            </a>
        </li>


        <li>
            <a href="#" onclick="loadPage('${pageContext.request.contextPath}/StaffChangePassword'); return false;">
        ...
        <li>
            <a href="#" onclick="loadPage('${pageContext.request.contextPath}/manageVouchers'); return false;">

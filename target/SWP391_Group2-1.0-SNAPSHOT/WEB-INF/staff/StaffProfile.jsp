    ...
    <body>
        ...
        <div class="content">
                ...
                <div class="actions">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="AdminProfileServlet">Xem Hồ Sơ Staff</a>
            ...
            <div style="margin-top: 20px;">
                <a href="staff" class="btn-export"><i class="fa-solid fa-arrow-left icon"></i> Quay lại Dashboard</a>
            </div>
        </div>
    </body>
</html>

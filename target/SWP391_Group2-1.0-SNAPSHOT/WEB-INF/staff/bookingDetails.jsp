...
<body>
    <div class="container">
        ...
        <!-- Thông báo ban đầu từ server (sẽ bị thay thế bởi thông báo AJAX) -->
        ...
        <div class="section" id="bookingSection">
            ...
            <table class="table table-bordered">
                ...
                <tr><th>Thời Gian Đặt</th><td class="read-only"><span>${booking.bookingDate}</span></td><td class="editable"><input type="text" value="${booking.bookingDate}" readonly></td></tr>
            ...
            <button id="updateBookingBtn" class="btn btn-primary mt-2" style="display: none;">Cập Nhật Booking</button>
            <button id="checkInBtn" class="btn btn-primary mt-2 ms-2">Thực Hiện Check-in</button>
        </div>
        ...
        <div class="section">
            ...
            <table class="table table-bordered">
                <tr><th>Mã Chuyến Bay</th><td><input type="text" value="${flight.flightNumber}" readonly></td></tr>
                <tr><th>Điểm Đi</th><td><input type="text" value="${flight.routeFrom}" readonly></td></tr>
                <tr><th>Điểm Đến</th><td><input type="text" value="${flight.routeTo}" readonly></td></tr>
                <tr><th>Thời Gian Cất Cánh</th><td><input type="text" value="${flight.departureTime}" readonly></td></tr>
                <tr><th>Thời Gian Hạ Cánh</th><td><input type="text" value="${flight.arrivalTime}" readonly></td></tr>
                <tr><th>Máy Bay</th><td><input type="text" value="${flight.aircraft}" readonly></td></tr>
            </table>
        </div>

            ...
            <div class="form-container  mt-4">
                ...
                <form action="manageVouchers" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="discount_percent" name="discount_percent" value="${voucher.discount_percent}" min="0" max="100" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="discount_max_amount" name="discount_max_amount"
                               value="${voucher.discountMaxAmount != null ? voucher.discountMaxAmount : ''}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="min_order_value" name="min_order_value"
                               value="${voucher.minOrderValue != null ? voucher.minOrderValue : ''}">
                    </div>

                    <div class="form-group">
                        <label for="min_people">Số người tối thiểu để sử dụng voucher(không bắt buộc)</label>
                        <input type="number" class="form-control" id="min_people" name="min_people"
                               value="${voucher.minPeople != null ? voucher.minPeople : ''}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group form-check">
                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" <c:if test="${voucher.isActive}">checked</c:if>>

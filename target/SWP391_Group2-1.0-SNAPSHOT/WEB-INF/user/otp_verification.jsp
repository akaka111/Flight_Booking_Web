...
<%-- 
    ...
    Created on : Aug 1, 2025, 12:20:04 PM
    Author     : Khoa
--%>
...
<head>
    ...
    <title>Xác thực OTP - Flight Booking Web</title>
...
<body>
    ...
    <section class="hero-section">
        ...
        <div class="otp-container">
            <h2><i class="fa-solid fa-key"></i> Xác thực OTP</h2>
            <p>Nhập mã OTP được gửi đến <strong>${email}</strong></p>
            ...
            <form method="post" action="<c:url value='/verify-otp'/>">
                <div class="form-group">
                    <label for="otp"><i class="fa-solid fa-code"></i> Mã OTP</label>
                    <input type="text" id="otp" name="otp" placeholder="Mã OTP" required>
                </div>

cảm ơn bạn đã giúp tôi chỉnh sửa, nhưng do jsp với doanh thu có số lớn, bạn hãy giúp tôi tách ra 2 chart xem 
<%-- 
    Document   : statistics
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="stat-card" style="grid-column: 1 / -1;">
                <h3>Biểu đồ thống kê theo năm ${param.year}</h3>
            ...
            new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Thống kê doanh thu & tài khoản năm ${param.year}'
                        }
                    },
                    scales: {
                        y: {

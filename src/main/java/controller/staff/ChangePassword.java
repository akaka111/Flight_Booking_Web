 ...
 * @author ADMIN
 */
@WebServlet(name = "StaffChangePassword", urlPatterns = {"/StaffChangePassword"})
public class ChangePassword extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/staff/StaffChangePassword.jsp").forward(request, response);
    }

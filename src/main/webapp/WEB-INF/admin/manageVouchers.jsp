    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="table-container">
                ...
                <a href="manageVouchers?action=create" class="btn btn-success mb-3">Add New</a>
                <c:choose>
                    <c:when test="${empty list}">
                        <p style="color: red;">Hiện chưa có voucher nào.</p>
                    </c:when>
                    <c:otherwise>
                            ...
                            <tbody>
                                <c:forEach var="v" items="${list}">
                                    <tr>
                                        ...
                                        <td>${v.usage_limit}</td>
                                        <td>
                                            <a href="manageVouchers?action=edit&id=${v.voucher_id}" class="btn btn-primary btn-sm">Edit</a>

                                            <form action="manageVouchers" method="post" style="display:inline;" onsubmit="return confirm('Confirm delete?');">

...
<html lang="vi">
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/staff/sidebar.jsp" />
        ...
        <div class="content">
            ...
            <div class="hero-section">
                <div class="slider">
                    <div class="slide active" style="background-image: url('https://voicefpt.com.vn/wp-content/uploads/2019/12/dich-vu-tong-dai-doanh-nghiep-voice-fpt.jpeg');"></div>
                ...
                <div class="hero-content">
                    <h1>chào mừng bạn đến với hệ thống Staff</h1>
                </div>
            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                document.querySelector('.sidebar ul li a[onclick*="staff.jsp"]').parentElement.classList.add('active');

                ...
                <div class="search-form-container">
                    <form action="<c:url value='/search'/>" method="get" class="search-form">
                        <div class="form-group">
                            <label for="routeId"><i class="fa-solid fa-plane"></i> Tuyến bay</label>
                            ...
                            <c:forEach var="flight" items="${flights}" begin="0" end="4">
                                <a href="<c:url value='/flight-detail?id=${flight.flightId}'/>" class="deal-card">
                                    <div class="deal-card-inner">
                                        <div class="from-location">Từ <span>${flight.route.originCity}</span></div>
                                    ...
                                    <div class="to-location">Đến <span>${flight.route.destCity}</span></div>
                                </a>
                            </c:forEach>
                        </c:when>
                        <c:otherwise>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelector('.search-form').addEventListener('submit', function (e) {
                ...
                if (!routeId || !departureDate) {
                    e.preventDefault();
                    alert('Vui lòng chọn tuyến bay và ngày đi.');
                }
            });
        });
    </script>
